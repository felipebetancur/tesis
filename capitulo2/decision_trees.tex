...
nodos. Decimos que un grafo conexo y sin ciclos es un árbol si y sólo si $|E| =
|V| - 1$.  \FL{Un grafo es un árbol si y solo si es conexo y sin ciclos. Si $G$
  es árbol, entonces $|E| = |V| - 1$}
...
\JS{Agregar párrafo corto con métodos de aprendizaje: mencionar que existen y
  dar referencias, indicando brevemente en que se basan}