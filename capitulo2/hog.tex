	...
	\paragraph{Binarización} ~\\
		...
		\begin{figure}[htbp]
			...
			\subfloat[Descriptores HOG de la imagen original\label{fig: Image HOG}]{
				\fbox{ \includegraphics[scale=0.35]{img/letter_A_HOG.jpg} }
			}
