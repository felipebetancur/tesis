...
\label{subsection:resultados}
	...
	\textbf{buscar correlacion entre variables o co-ocurrencia entre variables. La idea es que el enfoque de Ferns es Semi naive debido a que cada dimension en un vector no son independientes entre si, ya que siempre va a haber algun grado de dependencia con otras  variables y eso es lo que intentamos capturar.}
