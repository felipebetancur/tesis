...
\label{section:Apendice-B}
	La mayor parte de los algoritmos fueron desarrollados en el Sistema O\-pe\-ra\-ti\-vo \textit{Ubuntu (Linux)}. Al haber elegido Python como lenguaje de programación permite utilizarlos en distintas plataformas, como \textit{Mac} y \textit{Windows}, sin problemas.
