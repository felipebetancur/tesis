...
set output './worst_bootstrap_8or3cpb_Alpha0,01_240.svg'
set grid
set key box right bottom
set title '8or3cpb_Alpha0.01_240'
set xlabel 'IPC'
set ylabel 'Accuracy'
plot './worst_bootstrap_8or3cpb_Alpha0.01_240.txt' using 1:2 with linespoints title '1', \
