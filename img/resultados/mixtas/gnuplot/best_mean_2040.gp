...
set style line 101 lc rgb 'yellow' pt 3   # star


plot './best_mean_2040.txt' using 1:2 with linespoints ls 1 title 'B/G=1', \
...
"<echo '1000 0.43'" with points ls 101 title 'baseline@Synth', \
