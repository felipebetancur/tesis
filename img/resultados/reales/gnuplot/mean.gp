set terminal svg size 640,480 fname 'Verdana' fsize 16
...
plot './mean.txt' using 1:2 with linespoints ls 1 title 'B/G=1', \
...
'' using 15:16 with lines ls 100 title 'baseline', \
